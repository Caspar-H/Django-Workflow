...
urlpatterns = [
    ...
    path('generate_site_survey_report2/<str:site_id>', views.generate_site_survey_report2,
         name='generate_site_survey_report2'),
    path('define_poi/<str:site_id>', views.POICreateView.as_view(), name='define_poi'),
    path('upload_site_survey/<str:site_id>', views.upload_site_survey, name='upload_site_survey'),
]
